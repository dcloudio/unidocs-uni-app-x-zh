...
在 HBuilderX 3.93 以下的版本或者 iOS 平台，await 不能与 [Promise](./buildin-object-api/promise.md) 一同使用，此时请分别参考：[安卓 异步函数](https://uniapp.dcloud.net.cn/plugin/uts-for-android.md#_6-11-synchronized-lock-等线程同步概念-在uts里怎么写)、[iOS 异步函数](https://uniapp.dcloud.net.cn/plugin/uts-for-ios.md#_5-1-13-异步方法)。
