...
支持[easycom](https://uniapp.dcloud.net.cn/component/README.html#easycom)。
...
- uts组件插件
	...
	它们同属于`uts插件`，是[uni_modules](https://uniapp.dcloud.net.cn/uni_modules.html)。api插件指能力扩展，比如蓝牙api。而组件插件指界面元素扩展，比如video、map、lottie动画等。
