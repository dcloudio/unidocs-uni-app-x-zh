...
示例 [详情](<!-- VUEJSON.E_lifecycle.page_monitor-app-lifecycle-composition.gitUrl -->)

::: preview <!-- VUEJSON.E_lifecycle.page_page-composition.webUrl -->

> 组合式 API

<!-- VUEJSON.E_lifecycle.page_monitor-app-lifecycle-composition.code -->

> 选项式 API

<!-- VUEJSON.E_lifecycle.page_monitor-app-lifecycle-options.code -->
