...
- 使用腾讯定位三方SDK和iOS14以上高精度定位时，需要在info.plist中配置对应的Key，参考[在info.plist配置定位相关的Key](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-modules.html#uni-getlocation)
:::
