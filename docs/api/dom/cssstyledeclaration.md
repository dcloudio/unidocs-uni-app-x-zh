...
<!-- CUSTOMTYPEJSON.CSSStyleDeclaration.methods.setProperty_1.name -->

<!-- CUSTOMTYPEJSON.CSSStyleDeclaration.methods.setProperty_1.description -->

<!-- CUSTOMTYPEJSON.CSSStyleDeclaration.methods.setProperty_1.compatibility -->

<!-- CUSTOMTYPEJSON.CSSStyleDeclaration.methods.setProperty_1.param -->

<!-- CUSTOMTYPEJSON.CSSStyleDeclaration.methods.setProperty_1.returnValue -->

<!-- CUSTOMTYPEJSON.CSSStyleDeclaration.methods.setProperty_1.tutorial -->
