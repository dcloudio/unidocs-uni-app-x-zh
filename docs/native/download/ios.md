...
**[下载地址](https://web-ext-storage.dcloud.net.cn/uni-app-x/sdk/iOS/UniAppX-iOS%405.03.zip)**
...
* 新增 目标语言为js时为对象字面量指定类型时不再进行字段值类型校验以便更高性能的使用type [文档](https://doc.dcloud.net.cn/uni-app-x/uts/data-type.html#type) <https://issues.dcloud.net.cn/pages/issues/detail?id=25766>
...
* 修复 API uni.getFileSystemManager rename 不支持目录路径 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=26433)
* 修复 发行 设置 CFBundleName 未生效 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=23236)
* 新增 组件 image 支持 base64 svg [文档](https://doc.dcloud.net.cn/uni-app-x/component/image.html) <https://issues.dcloud.net.cn/pages/issues/detail?id=22096>
* 修复 字符串中出现`/f`时编译器报错 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=25844)
* 新增 支持配置 Swift Package Manager（SPM）依赖 [文档](https://doc.dcloud.net.cn/uni-app-x/plugin/uts-ios-spms.html) <https://issues.dcloud.net.cn/pages/issues/detail?id=22374>
* 修复 uni-app兼容模式组件仅包含app-ios平台时，云打包未包含该组件 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=25830)
* 修复 云端打包部分情况可能没有包含uts插件配置 CocoaPods 依赖的动态库 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=25686)
### uni-app
* 修复 mapContext.includePoints 调用不生效的Bug [详情](https://ask.dcloud.net.cn/question/217064)
* 修复 input 组件设置 digit 属性光标调整失焦后数据错乱的Bug [详情](https://ask.dcloud.net.cn/question/203478)
* 修复 地图导航组件遮挡地理位置文字的Bug [详情](https://ask.dcloud.net.cn/question/216973)
* 修复 editorContext.format 传递空 name 没有终止逻辑服务执行的Bug [详情](https://ask.dcloud.net.cn/question/214259)
* 修复 input 组件快速输入导致失焦的Bug [详情](https://ask.dcloud.net.cn/question/216827)
* 修复 下拉刷新和 Swiper 组件滑动卡住的Bug [详情](https://ask.dcloud.net.cn/question/201306)
* 修复 4.81版本引发的 一键登录未勾选隐私协议时点击登录按钮无提示的Bug
* 修复 开启 `js/nvue文件原生混淆` 先通过 wgt 升级更新应用资源后再整包覆盖安装可能导致启动卡在启动页的Bug
