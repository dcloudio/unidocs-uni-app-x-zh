...
**[下载地址](https://web-ext-storage.dcloud.net.cn/uni-app-x/sdk/Android/Android-uni-app-x-SDK@12803-4.41.zip)**

* 更新 uni-app x 原生SDK打包支持，需使用HBuilderX（4.41.2024121203-alpha）版本生成本地打包App资源。
