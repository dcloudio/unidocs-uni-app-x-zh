...
**[下载地址](https://web-ext-storage.dcloud.net.cn/uni-app-x/sdk/Android/Android-uni-app-x-SDK@13309-4.61.zip)**

* 更新 uni-app x 原生SDK打包支持，需使用HBuilderX（4.61.2025040322-alpha）版本生成本地打包App资源。
